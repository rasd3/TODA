...
from eval_utils.generate_pseudo_labels_perturb import inference_and_generate_pseudo_labes_k
...
def generate_pseudo_labels(model, unlabel_loader, args, output_dir, logger, dist_test=False, unlabel_infos_path=None):
    ...
    inference_and_generate_pseudo_labes_k(cfg=cfg, args=args, model=model, dataloader=unlabel_loader, logger=logger, 
                                                           dist_test=dist_test, save_to_file=args.save_to_file, result_dir=output_dir, 
                                                           unlabel_infos_path=unlabel_infos_path, optimizer=optimizer)
