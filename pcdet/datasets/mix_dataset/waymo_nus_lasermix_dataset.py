...
class WaymoNusLaserMixDataset(CutMixDatasetTemplate):
    def __init__(self, dataset_cfg=None, training=True, dataset_names=None, logger=None):
        ...
        self.laser_pitch_angle = self.dataset_cfg.get('LASERMIX_PITCH_ANGLE', [-20, 0])
        self.laser_num_areas = self.dataset_cfg.get('LASERMIX_NUM_AREAS', 3)
        self.laser_num_angles = self.dataset_cfg.get('LASERMIX_NUM_ANGLES', None)
